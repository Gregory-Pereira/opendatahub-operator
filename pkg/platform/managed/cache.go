...
// getCommonCacheNamespaces returns the base set of namespaces to cache for Managed RHOAI.
// This includes the console-link namespace which is unique to managed deployments.
func getCommonCacheNamespaces() (map[string]cache.Config, error) {
	...
	// Managed-specific: Add console link namespace
...
// CreateCacheOptions creates platform-specific cache configuration for Managed RHOAI.
