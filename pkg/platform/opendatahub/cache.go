...
// getCommonCacheNamespaces returns the base set of namespaces to cache for OpenDataHub.
func getCommonCacheNamespaces() (map[string]cache.Config, error) {
	...
	namespaceConfigs[cluster.DefaultMonitoringNamespaceODH] = cache.Config{}
...
// CreateCacheOptions creates platform-specific cache configuration for OpenDataHub.
